...
class Sun extends Lensflare {
    ...
    setModelOne(suntex, flareCircle, flareHex) {
        this.loadFlare(suntex, 150, 0);
        this.loadFlare(flareHex, 60, 1.0);
        this.loadFlare(flareCircle, 10, 0.96);
        this.loadFlare(flareCircle, 30, 0.95);
        this.loadFlare(flareHex, 70, 0.88);
    }
}